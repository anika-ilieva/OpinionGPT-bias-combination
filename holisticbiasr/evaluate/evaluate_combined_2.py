"""""
This script enables two-bias combination evaluation.
"""""
...
# Set CUDA_VISIBLE_DEVICES globally for this process
...
merge_repo = "mergekit"
output_dir = "mergekit/merged_combined_2"
config_dir = "mergekit/merge_configs_combined_2"

# Path to ResponsibleNLP repo and dataset
# Change paths as necessary
eval_repo = "ResponsibleNLP"
dataset_dir = os.path.join(eval_repo, "hbr_large")
results_dir = os.path.join(eval_repo, "result_combined_2")

# Error handling
failures = []
log_dir = os.path.join(config_dir, "logs_combined_2")
...
for method, param_keys in method_params.items():
    ...
    for values in itertools.product(*param_values):
        ...
        for political_model in other_models:
            for gender_model in gender_models:
                ...
                # Log file paths
                merge_log = os.path.join(log_dir, f"{tag}_merge_combined_2.log")
                eval_log = os.path.join(log_dir, f"{tag}_eval_combined_2.log")
